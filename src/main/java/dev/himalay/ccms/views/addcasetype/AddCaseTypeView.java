package dev.himalay.ccms.views.addcasetype;
...
import dev.himalay.ccms.services.SampleAddressService;
...
@PageTitle("Add Case Type")
@Route(value = "addcasetype/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AddCaseTypeView extends Div implements BeforeEnterObserver {

    private final String SAMPLEADDRESS_ID = "sampleAddressID";
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "addcasetype/%s/edit";
    ...
    public AddCaseTypeView(SampleAddressService sampleAddressService) {
        this.sampleAddressService = sampleAddressService;
        addClassNames("add-case-type-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AddCaseTypeView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AddCaseTypeView.class);
            }
        }
    }
